...
// func (d *BlobLibrary) OpenSnapshot(ctx context.Context, id string) (Snapshot, error) {
// 	return newBlobWriter(d.BasePath, id)
// }

// var _ Snapshot = (*blobWriter)(nil)
...
// func (d *blobWriter) WriteManifest(ctx context.Context, manifest Manifest) error {
